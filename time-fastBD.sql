...
INSERT INTO envio (
    idCliente, origenCalle, origenNumero, origenColonia, origenCodigoPostal, origenCiudad, origenEstado, noGuia, costoDeEnvio, idEstadoDeEnvio, idColaborador, destino
)
VALUES
(1, 'Av. Siempre Viva', '123', 'Centro', '45678', 'Ciudad México', 'CDMX', 'GUI001', 150.00, 1, 1, 'Calle Falsa 123, CDMX'),
(2, 'Calle Independencia', '45', 'Reforma', '54321', 'Guadalajara', 'Jalisco', 'GUI002', 200.00, 2, 2, 'Calle Real 456, Guadalajara');
...
VALUES
(1, 'Paquete pequeño', 2.5, 30.0, 20.0, 15.0),
(2, 'Caja mediana', 5.0, 50.0, 40.0, 30.0);
...
VALUES
(1, 1, 'GUI001', 'Paquete registrado en el sistema', '2025-01-10'),
(2, 2, 'GUI002', 'Envío asignado a conductor', '2025-01-10');
